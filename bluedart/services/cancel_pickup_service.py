"""
Cancel Pickup Service Module
"""

from bluedart.base_service import BlueDartBaseService


class BlueDartCancelPickupRequest(BlueDartBaseService):
    """
    ...
    def __init__(self, profile_obj, *args, **kwargs):
        ...
        super(BlueDartCancelPickupRequest, self).__init__(wsdl_url, *args, **kwargs)
    ...
    def _prepare_wsdl_objects(self):
        ...
        self.request = self.client.factory.create('ns2:CancelPickupRequest')
    ...
    def _assemble_and_send_request(self):
        ...
        # Fire off the query.
        return self.client.service.CancelPickup(self.request, self.profile)
